package sg.nus.edu.iss.project12.controller;
...
import sg.nus.edu.iss.project12.exception.RandNoException;
import sg.nus.edu.iss.project12.model.Generate;
...
public class GenerateRandController {
    ...
    public String showRandForm(Model m){
        //reference var g is an object which contains numberVal
        Generate g = new Generate();
        m.addAttribute("generateObj", g);
        return "generate";
    }

    @GetMapping(path="/generates")
    ...
    private void randomizerNum(Model m, int noOfGenerateNo){
        ...
        for (Iterator iter = uniqueResult.iterator(); iter.hasNext();){
            ...
            //add names of files into string list of selected images. 
